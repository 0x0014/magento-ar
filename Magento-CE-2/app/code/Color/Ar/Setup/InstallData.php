    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context) {
        ...
        $eavSetup->addAttribute(
            ...
            [
                ...
                'label' => 'AR File',
                'input' => 'file',
                'backend' => 'Color\Ar\Model\Product\Attribute\Backend\File',
                'frontend' => '',
                'class' => '',
                'source' => '',
        ...
        foreach ($attributeSetCollection as $attributeSet) {
            $eavSetup->addAttributeToSet("catalog_product", $attributeSet->getAttributeSetName(), "General", "ar_file");
        }
    }
}